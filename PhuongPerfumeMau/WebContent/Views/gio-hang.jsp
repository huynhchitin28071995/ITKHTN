                        ...
                        <div class="woocommerce">
                            <form method="post" action="#">
                                <table cellspacing="0" class="shop_table cart">
                                    ...
                                    <tbody>
                                    <c:forEach items="${dsspMua}" var="spMua" >
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/${spMua.hinhAnh }"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="single-product.html">${spMua.tenSanPham }</a> 
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">${spMua.donGiaKM }</span> 
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="${spMua.soLuongMua }" min="0" step="1">
                                                    <input type="button" class="plus" value="+">
                                                </div>
                                            </td>

                                            <td class="product-subtotal">
                                                <span class="amount">${spMua.thanhTien() }</span> 
                                            </td>
                                        </tr>
                                        </c:forEach>
                                        <tr>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            ...
                                            <td><span class="amount">${thanhTien}</span></td>
                                        </tr>
