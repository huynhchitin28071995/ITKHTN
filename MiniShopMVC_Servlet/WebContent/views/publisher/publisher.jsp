...
<div class="page-header">Manage Publisher</div>
	...
	<form action="${pageContext.request.contextPath }/publisher/dels.html" method="post">
		...
		<tr>
		<td><input type="checkbox" value="${publisher.publisherId }" name="boxes"></td>
		...
		<td><a href="${pageContext.request.contextPath }/admin/publisher/del.html?publisherId=${publisher.publisherId}"><img src="${pageContext.request.contextPath }/images/trash.png"></a>
		</tr>
