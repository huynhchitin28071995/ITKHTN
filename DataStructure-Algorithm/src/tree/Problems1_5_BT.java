...
//					if(cur.right!= null) // this will make cur always not null
	...
	private static void problem5(BinaryTreeNode root, BinaryTreeNode addedE) { // insert an element. Using level order
																				// traversal.
		if (root == null) {
			root = addedE;
			return;
...
//		System.out.println(problem3(b, new BinaryTreeNode(10)));
		problem5(b, new BinaryTreeNode(8));
		problem5(b, new BinaryTreeNode(9));
		problem5(b, new BinaryTreeNode(10));
		System.out.println(b.levelOrder(b));
	}
}
